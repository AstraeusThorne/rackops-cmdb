...
import './DutyPersonnelOperations.css';

/**
 * 值班人员操作记录页面
 * 显示值班人员的详细操作记录（创建事件、告警、设备、人员等）
 */
const DutyPersonnelOperations = () => {
  ...
  return (
    <div className="duty-personnel-operations-page">
      <Card
        className="duty-personnel-operations-card"
        title={
...
export default DutyPersonnelOperations;
