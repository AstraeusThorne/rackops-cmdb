...
from .aggregation_helpers import get_yearly_report_summary_and_sections


class YearlyReportAggregator(BaseReportAggregator):
    """年报聚合器：产出《数据中心年度运营分析报告》8 Sheet 结构。"""
    ...
    def aggregate(
        ...
        summary, sections = get_yearly_report_summary_and_sections(
